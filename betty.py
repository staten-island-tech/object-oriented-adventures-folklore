...
class Betty:
    ...
    def first_en_bet():
        ...
        def Yes_Going_to_Betty():
            ...
            Climb_Poets_Tower = typingInput(boxed_msg("Either way, Betty approaches you. Are you here to climb the Tortured Poets Department? Y/N \n(You also have the option to ask for information about the tower.)")).upper()
            time.sleep(2)
            os.system('cls')
        ...
        def Input_Climb_Poets_Tower():
            if Climb_Poets_Tower == "Y":
                os.system('cls')
                yes_to_climb_poets_tower()
            if Climb_Poets_Tower == "N":
                os.system('cls')
